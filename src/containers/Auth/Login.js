...
class Login extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (
      nextProps.loginReducer &&
      nextProps.loginReducer.response &&
      nextProps.loginReducer.response.result &&
      nextProps.loginReducer.response.response &&
      nextProps.loginReducer.response.response.user
    ) {
  ...
  render() {
    return (
      <>
        {this.state.loggedIn ? <Navigate to="/template/dashboard" /> : null}
